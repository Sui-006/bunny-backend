...
export const AI_PERMISSION_POLICY = {
  journal:      { read: true,  create: false, write: false, delete: false },
  ...
  health:       { read: true,  create: true,  write: true,  delete: true },
  finance:      { read: true,  create: true,  write: true,  delete: true },
  ...
  // AI 动态（AI 自己的活动流水）：AI 可回看自己做过什么，也可「新增」一条自己的动态；但不可改写/删除历史。
  activity:     { read: true,  create: true,  write: false, delete: false },
};
...
export const ACTION_LABEL = { read: '读取', create: '创建', update: '修改', delete: '删除' };

...
export const AI_PERMISSION_POLICY = {
  ...
  // 经期（健康隐私）：AI 只读，绝不 create/write/delete。用户在 Period 页面自行记录/编辑，
  // 该页面走前端/REST 路径，不经 AI 权限，故收紧 AI 权限不影响用户自己的经期功能。
  menstrual:    { read: true,  create: false, write: false, delete: false },
...
export const TOOL_ACTIONS = {
  ...
  // 经期逐日记录（period/flow/symptoms/spotting/bbt）：只读，精确到 menstrualDays 实体
  get_menstrual_records: { entity: 'menstrual', entityKey: 'menstrualDays', action: 'read' },
  // 音乐
